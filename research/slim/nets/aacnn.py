...
def aacnn_base(inputs,
  ...
  Constructs an AACNN network from inputs to the given final endpoint.
  This method is as
  described in http://arxiv.org/abs/1904.09925.

  TODO: make this respect input args
  Args:
  ...
  with tf.variable_scope(scope, 'AACNN', [inputs]):
    with slim.arg_scope(
