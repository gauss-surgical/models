...
class SSDInceptionV4FeatureExtractor(ssd_meta_arch.SSDFeatureExtractor):
  """SSD Feature Extractor using InceptionV4 features."""
  ...
  def __init__(self,
    ...
    """InceptionV4 Feature Extractor for SSD Models.
    ...
    """
    super(SSDInceptionV4FeatureExtractor, self).__init__(
  ...
  def extract_features(self, preprocessed_inputs):
    ...
    feature_map_layout = {
        'from_layer': ['Mixed_5e', 'Mixed_6h', 'Mixed_7d', '', '', ''],
    ...
    with slim.arg_scope(self._conv_hyperparams_fn()):
      with tf.variable_scope('InceptionV4', reuse=self._reuse_weights) as scope:
